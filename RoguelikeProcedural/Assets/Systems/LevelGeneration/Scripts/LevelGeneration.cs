...
public class LevelGeneration : MonoBehaviour
{
    ...
    void DrawMap()
    {
        foreach (RoomV2 room in rooms)
        {
            ...
            MapSpriteSelector mapper = Object.Instantiate(roomWhiteObj, new Vector3(drawPos.x, 0, drawPos.y), Quaternion.identity).GetComponent<MapSpriteSelector>();
